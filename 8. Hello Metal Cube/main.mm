...
int main(int argc, const char* argv[])
{
    ...
    mainWindow.title = @"Hello Metal Cube";
    ...
    id<MTLBuffer> cubeVertexBuffer = [mtlDevice newBufferWithBytes:vertexData 
                                                length:sizeof(vertexData)
                                                options:MTLResourceOptionCPUCacheModeDefault];

    id<MTLBuffer> cubeIndexBuffer = [mtlDevice newBufferWithBytes:indices 
